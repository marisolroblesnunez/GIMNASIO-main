...
// que manera es mejor para obtener los testimonios, si con un join o con una subconsulta?




//function obtenerTestimonios($pdo) {
//     $sql = "
//         SELECT t.id, t.mensaje, t.fecha, c.nombre, t.visible
//         FROM testimonios t
//         JOIN clientes c ON t.id_cliente = c.id
//         ORDER BY t.fecha DESC
//     ";
...
//     return $stmt->fetchAll(PDO::FETCH_ASSOC);
// }
// function actualizarVisibilidadTestimonio($pdo, $id, $visible) {
